...
(function() {
  var BusLineStartTime, BusLineStation, Busline, City, Company, Feedback, Hotline, Phone, Promise, Sequelize, Station, Stime, User, _, addRecords, addStartTime, getDate, squelize;
  ...
  squelize.query('SET FOREIGN_KEY_CHECKS = 0').spread(function(results, metadta) {
    return Feedback.sync().then(function() {
      return Stime.sync();
    }).then(function() {
      return Company.sync();
    }).then(function() {
