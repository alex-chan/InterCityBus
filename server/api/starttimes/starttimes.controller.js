...
(function() {
  ...
  module.exports.index = function(req, res) {
    return Model.Starttime.findAll().then(responseWithResult(res))["catch"](handleError(res));
  };

  module.exports.show = function(req, res) {
    return Model.Starttime.findOne({
      where: {
        id: req.params.id
      }
  ...
  module.exports.create = function(req, res) {
    return Model.Starttime.create(req.body).then(responseWithResult(res, 201))["catch"](handleError(res));
  };
