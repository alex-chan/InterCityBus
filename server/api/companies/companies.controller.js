...
(function() {
  ...
  module.exports.index = function(req, res) {
    return Model.Company.findAll().then(responseWithResult(res))["catch"](handleError(res));
  };
  ...
  module.exports.create = function(req, res) {
    return Model.Company.create(req.body).then(responseWithResult(res, 201))["catch"](handleError(res));
  };
